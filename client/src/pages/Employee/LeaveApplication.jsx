        ...
        <>
            <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-around' }}>
                ...
                <div className="page__heading" >
                    <h1>Add New<br />Leave Application</h1>
                </div>
            </div>
            ...
            <section className="form">
                <form onSubmit={onSubmit}>
                    <div className="form-group">
                        ...
                        <select className="form-control" id="LeaveType" name="LeaveType" onChange={onChange}>
                    ...
                    <div className="form-group">
                        ...
                        <input type="date" className="form-control" id="FromDate" name="FromDate" onChange={onChange} />
                    </div>

                    <div className="form-group">
                        <label htmlFor="ToDate">To Date</label>
                        <input type="date" className="form-control" id="ToDate" name="ToDate" onChange={onChange} />
                    </div>

                    <div className="form-group">
                        <label htmlFor="Reason">Reason</label>
                        <textarea className="form-control" id="Reason" name="Reason" rows="3" onChange={onChange} />
                    </div>

                    <div className="form-group">
                        <label htmlFor="Status">Status</label>
                        <select className="form-control" id="Status" disabled name="Status" onChange={onChange}>
